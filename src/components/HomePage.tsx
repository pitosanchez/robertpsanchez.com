...
IgA Nephropathy is another rare kidney condition, sometimes called Berger's disease, which occurs when an antibody called immunoglobulin A builds up in the kidneys, causing inflammation. This inflammation can eventually impair kidney function, especially when left undiagnosed or untreated. Like FSGS, it's often invisible until it's advanced, and it’s not widely understood in many communities, and although IgA nephropathy is more commonly reported in people of European ancestry, it affects people across all backgrounds—often going undiagnosed or poorly managed in communities with less access to specialty care and kidney-health education.
